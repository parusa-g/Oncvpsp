...
write(6,'(/a)') 'AE derivatives'
write(6,'(6f12.6)') (uord(ii),ii=1,ncon)
...
write(6,'(/a,f10.6)') '    E00 =', eresid0(1)
write(6,'(/a,3f10.6)') '    Ei0 =', (eresiddot(ii,1), ii=1,nnull)
write(6,'(/a)') '    Eii ='
do ii=1,nnull
   write(6,'(3f10.6)') (eresidmat(ii,jj,1), jj=1,nnull)
end do
